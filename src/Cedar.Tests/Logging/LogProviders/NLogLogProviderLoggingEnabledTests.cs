namespace Cedar.Logging.LogProviders
{
    ...
    public class NLogLogProviderLoggingEnabledTests : IDisposable
    {
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Debug, () => "m", new Exception("e"));
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Debug, () => "m");
            Assert.NotEmpty(_target.Logs);
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Error, () => "m", new Exception("e"));
            Assert.NotEmpty(_target.Logs);
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Error, () => "m");
            Assert.NotEmpty(_target.Logs);
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Fatal, () => "m", new Exception("e"));
            Assert.NotEmpty(_target.Logs);
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Fatal, () => "m");
            Assert.NotEmpty(_target.Logs);
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Info, () => "m", new Exception("e"));
            Assert.NotEmpty(_target.Logs);
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Info, () => "m");
            Assert.NotEmpty(_target.Logs);
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Trace, () => "m", new Exception("e"));
            Assert.NotEmpty(_target.Logs);
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Trace, () => "m");
            Assert.NotEmpty(_target.Logs);
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Warn, () => "m", new Exception("e"));
            Assert.NotEmpty(_target.Logs);
        ...
        {
            _sut.Log(Cedar.Logging.LogLevel.Warn, () => "m");
            Assert.NotEmpty(_target.Logs);
