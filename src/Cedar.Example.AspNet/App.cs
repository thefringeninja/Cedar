namespace Cedar.Example.AspNet
{
    ...
    public class App : IDisposable
    {
        ...
        private App()
        {
            var settings = new DefaultCommandHandlerSettings(
                new HandlerModule(),
                new DefaultCommandTypeFromContentTypeResolver("cedar", Enumerable.Empty<Type>()),
            ...
            _durableCommitDispatcher.CommitsProjectedStream.Subscribe(
                _ => { },
                ex =>
                {
